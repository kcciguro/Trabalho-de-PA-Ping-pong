...
5. Inteligência Artificial do Oponente: O robô monitoriza a trajetória da bola e desloca-se lateralmente para rebatê-la quando ela atinge o fundo da mesa ($Z \approx 1.0$), aplicando devoluções automáticas com base no ponto de impacto.
##  Atenção
